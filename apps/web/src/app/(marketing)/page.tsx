...
import { isFeatureVisible } from "@/lib/site-visibility";
...
export default async function Home() {
  const [featuredProjects, visibility] = await Promise.all([
    getFeaturedProjects(),
    getBootstrapVisibility(),
  ]);
          ...
          <Container>
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="flex flex-col justify-between bg-purple/10 p-6">
                <div>
                  <h3 className="font-display text-xl font-light">Not sure which box I fit?</h3>
                  <p className="mt-2 text-sm text-muted">
                    Filter by craft below, or upload a job description for an honest 0–10 fit
                    score.
                  </p>
                </div>
        ...
        <section className="py-20">
          <Container>
            <div className="flex items-end justify-between gap-6">
              <SectionHeading eyebrow="Selected work" title="Real problems, shipped solutions" />
            ...
            <Card className="relative overflow-hidden p-10 sm:p-14">
              ...
              <div className="relative max-w-2xl">
                ...
                <p className="mt-5 text-muted">
                  It answers honestly - never inventing experience - and helps you see where
                  I&apos;d add value, even where I&apos;m still growing.
                </p>
